...

{
    ...
    public class EditModel : PageModel
    {
        ...
        [BindProperty]
        public string currentEE { get; set; }
        ...
        public List<SelectListItem> SalesPeople { get; } = new List<SelectListItem>
        {
            ...
            new SelectListItem { Value = "Seidl", Text = "Seidl"  },
            new SelectListItem { Value = "Mo", Text = "Mo"  },
            new SelectListItem { Value = "Song", Text = "Song"  },
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            using (var smtp = new SmtpClient())
            {
                ...
                var message = new MailMessage
                {
                    ...
                    From = new MailAddress("ProjectAssigned@DoNotReplyraffel.com")
                };
        ...
        private bool ProjectsExists(string LEAD_NUMBER)
        {
            return _context.Projects.Any(e => e.LEAD_NUMBER.Equals(LEAD_NUMBER));
        }
    }
}
